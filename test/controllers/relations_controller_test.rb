...
class RelationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relation" do
    assert_difference('Relation.count') do
      post relations_url, params: { relation: { question_id: @relation.question_id, test_id: @relation.test_id } }
    end
  ...
  test "should update relation" do
    patch relation_url(@relation), params: { relation: { question_id: @relation.question_id, test_id: @relation.test_id } }

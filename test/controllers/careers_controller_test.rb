...
class CareersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create career" do
    assert_difference('Career.count') do
      post careers_url, params: { career: { career: @career.career, test_id: @career.test_id } }
    end
  ...
  test "should update career" do
    patch career_url(@career), params: { career: { career: @career.career, test_id: @career.test_id } }

...
class ClassificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classification" do
    assert_difference('Classification.count') do
      post classifications_url, params: { classification: { description: @classification.description } }
    end
  ...
  test "should update classification" do
    patch classification_url(@classification), params: { classification: { description: @classification.description } }

class CareersController < ApplicationController
  ...
  # GET /careers.json
  def index
    @careers = Career.joins(:test).select("careers.id, careers.career, tests.indentifier")
  end
  ...
  def destroy
    @career.destroy
    respond_to do |format|
      format.html { redirect_to careers_url, notice: 'Carrera eliminada exitosamente.' }
  ...
  private
    ...
    def career_params
      params.require(:career).permit(:test_id, :career)
    end
end
